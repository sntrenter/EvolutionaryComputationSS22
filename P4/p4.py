...
from CompactGA import CompactGA
...
def main():
    ...
    if(runmode == 4):
        print("Running in Compact GA Mode...")
        CompactGA(populationSizeN=populationSizeN,stringSizen=stringSizen,fitnessFunction=FITNESS_LIST[fitnessFunction],graphing=graphing)
