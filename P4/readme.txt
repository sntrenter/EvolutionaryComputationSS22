This Version comes with 5 modes which are selected using the runmode command. 
...
Compact mode:
set runmode to 4 and you enable this mode,
Runs in compact mode


### 
In short 
just use ./p4.py to run, you can specify a settings file, or edit the variables 
...
CompactGA.py: compact GA mode
P4.pdf: my report portion of this
